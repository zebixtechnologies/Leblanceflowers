...
if (isset($_POST['manageProduct'])) {
    ...
    <div class="card shopping-cart">
        ...
        foreach ($dataOfCart as $result){
            ...
            $pr= $obj->get1($result['product_id'],$result['product_type'],$result['gift_type']);
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="text-sm-center text-md-left col-md-6">
                        ...
                        <h4>
                            <small><?php echo utf8_encode($prn['product_description']); ?></small>
                        </h4>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <a href="checkout.php" class="btn btn-primary btn-lg btn-block"> Continue To Next Step</a>
        </div>
    </div>
    <?php
}

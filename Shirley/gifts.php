...
<div class="container">
    <div class="row">
        <div class="col-md-12 ">
                    ...
                    <div class="row item-pane py-5">
                        ...
                        foreach ($row_alcohol as $row) { ?>
                            <div class="col-sm-3 p-c text-center pb-2 border-0">
                                ...
                                <img width="300" height="300" src="assets/Product_Images/<?php echo $row['image']; ?>" alt="">
                                <div class="dropdown-divider"></div>
                                <p class="lead"><?php echo $row['name']; ?></p>
                                <p class="price-box mt-2">$<?php echo $row['price']; ?></p>
                                <a class="btn btn-primary btn-xl" href="">Add To Cart</a>
                            </div>
                            <?php } ?>
                    </div>
</div>
            ...
            <button class="btn btn-primary btn-xl float-right">Continue To CheckOut</button>
